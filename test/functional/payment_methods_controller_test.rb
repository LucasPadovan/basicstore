...
class PaymentMethodsControllerTest < ActionController::TestCase
  ...
  test "should create payment_method" do
    assert_difference('payment_method.count') do
      post :create, :payment_method => {:name => "Otro medio de pago", :description => "Descripcion detallada"}
    end
  ...
  test "should destroy payment_method" do
    assert_difference('payment_method.count', -1) do
